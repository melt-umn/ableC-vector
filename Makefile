...
EXT_NAME=ableC-vector
EXT_GRAMMAR=edu:umn:cs:melt:exts:ableC:vector
EXT_DEPS=ableC-allocation ableC-constructor ableC-templating ableC-template-constructor ableC-string
